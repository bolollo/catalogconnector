...
<!--	For now, this template is a modified version of that created and used in exCat. Changes
to the xsl will be made - this script is necessary now though, to show that the back end code
is working.
-->
