...
OpenLayers.Strategy.OpenSearch = OpenLayers.Class(OpenLayers.Strategy, {
    ...
    loadDescription: function(response) {
        ...
        if(!this.description) {
            ...
            this.events.triggerEvent("descriptionloadend", {url: this.descriptionurl, description: null});
        	return false;
        }
        ...
        this.events.triggerEvent("descriptionloadend", {url: this.descriptionurl, description: this.description});
